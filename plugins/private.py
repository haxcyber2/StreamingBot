...
async def start(client, message):
    ...
    m=await message.reply_photo(photo=Config.THUMB_LINK, caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id))
    await delete(m)
...
async def show_help(client, message):
    ...
    if Config.msg.get('help') is not None:
        try:
            ...
            pass
    Config.msg['help'] = await message.reply_photo(photo=Config.THUMB_LINK, caption=HELP_TEXT)
